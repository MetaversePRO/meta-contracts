...
contract sMeta is ERC20Permit, DaoOwnable {
    ...
    constructor() ERC20("Staked Meta", "sMeta", 9) ERC20Permit() {
    ...
    /**
        @notice increases sMETA supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sMETA
